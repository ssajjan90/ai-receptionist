...
VALUES
(NULL, 'CLINIC', 'Hours', 'HOURS', 'What are your working hours?',
...
(NULL, 'CLINIC', 'Pricing', 'PRICE', 'How much does treatment cost?',
...
(NULL, 'HOTEL', 'Booking', 'BOOKING', 'Do you have rooms available?',
...
(NULL, 'HOTEL', 'Tariff', 'PRICE', 'What is the room price?',
...
(NULL, 'SALON', 'Services', 'SERVICES', 'What services do you offer?',
...
(NULL, 'SALON', 'Pricing', 'PRICE', 'What are your service charges?',
...
(NULL, 'MOBILE_SHOP', 'Availability', 'AVAILABILITY', 'Is this phone model available?',
...
(NULL, 'MOBILE_SHOP', 'Price', 'PRICE', 'What is the mobile price?',
...
(NULL, 'CLINIC', 'ಸಮಯ', 'HOURS', 'ನಿಮ್ಮ ಕೆಲಸದ ಸಮಯ ಏನು?',
...
(NULL, 'HOTEL', 'ಬುಕಿಂಗ್', 'BOOKING', 'ಕೊಠಡಿ ಲಭ್ಯವಿದೆಯೆ?',
...
(NULL, 'SALON', 'ಸೇವೆಗಳು', 'SERVICES', 'ನೀವು ಯಾವ ಸೇವೆಗಳು ನೀಡುತ್ತೀರಿ?',
...
(NULL, 'MOBILE_SHOP', 'ಲಭ್ಯತೆ', 'AVAILABILITY', 'ಈ ಫೋನ್ ಮಾದರಿ ಲಭ್ಯವಿದೆಯೆ?',
